        ...
        <div class="container-fluid">
            <form method="post">
                ...
                <label for ="source">Quelle<small>(newsletter etc.)</small></label>
                     <input class="form-control" type="text" required placeholder="newsletter..." id="source"
                            name="source" value="<?PHP if(isset($_POST['source'])){ echo $_POST['source']; }?>">
                <br>
                <span>*</span>
                <label for ="medium">Versandmedium <small>(z.b. E-Mail)</small></label>
                     <input class="form-control" type ="text" required placeholder="Marketing medium.." id="medium"
                            name="medium" value="<?PHP if(isset($_POST['medium'])){ echo $_POST['medium']; }?>">
                <br>
                <span>*</span>
                <label for ="campaign">Kampagne</label>
                     <input class="form-control" type ="text" required placeholder="Produkt, promo code.." id="campaign"
                            name="campaign" value="<?PHP if(isset($_POST['campaign'])){ echo $_POST['campaign']; }?>">
                <br>
                <span>*</span>
                ...
                <label for ="term">Term</label>
                    <input class="form-control" type ="text" placeholder="Keywords.." id="term" name="term"
                           value="<?PHP if(isset($_POST['term'])){ echo $_POST['term']; }?>">
                <br>
                ...
                <label id="labeltextarea">
                    Tiny URL :
                <textarea id="secarea" class="form-control" rows="3" readonly>
                    <?php
                       if (isset($_POST['url']))
                       {
                            require_once('./Models/TinyUrl.php');
